  ...
  if (typeof section === "object" && section !== null) {
    try {
      ...
      if (tinymce.get("teylerDescription1")) {
        tinymce
          .get("teylerDescription1")
          .setContent(section.description1 || "");
      }
      if (tinymce.get("teylerDescription2")) {
        tinymce
          .get("teylerDescription2")
          .setContent(section.description2 || "");
      }
      ...
      if (section.faq && Array.isArray(section.faq)) {
        ...
        console.warn(
          "No FAQ data found for teyler section or data is not an array"
        );
      }
    } catch (e) {
  ...
  if (typeof section === "object" && section !== null) {
    try {
      ...
      if (tinymce.get("lorentzDescription1")) {
        tinymce
          .get("lorentzDescription1")
          .setContent(section.description1 || "");
      }
      if (tinymce.get("lorentzDescription2")) {
        tinymce
          .get("lorentzDescription2")
          .setContent(section.description2 || "");
      }
      ...
      if (section.faq && Array.isArray(section.faq)) {
        ...
        console.warn(
          "No FAQ data found for lorentz section or data is not an array"
        );
      }
    } catch (e) {
    ...
    console.error(
      "No lorentz section data found or data is in invalid format."
    );
  }
}
  ...
  if (Array.isArray(faqArray)) {
    faqArray.forEach((faq, index) => {
      ...
      try {
        ...
        console.error(
          `Error setting FAQ content for ${questionId}/${answerId}:`,
          e
        );
      }
    });
    ...
    console.error(
      `No FAQ data found for ${sectionPrefix} or data is not an array`
    );
  }
}
...
function collectPageData() {
  try {
    return {
      intro: {
        title1: tinymce.get("introTitle1")
          ? tinymce.get("introTitle1").getContent()
          : "",
        title2: tinymce.get("introTitle2")
          ? tinymce.get("introTitle2").getContent()
          : "",
        title3: tinymce.get("introTitle3")
          ? tinymce.get("introTitle3").getContent()
          : "",
        text: tinymce.get("introText")
          ? tinymce.get("introText").getContent()
          : "",
      },
      teylerSection: {
        title: tinymce.get("teylerTitle")
          ? tinymce.get("teylerTitle").getContent()
          : "",
        description1: tinymce.get("teylerDescription1")
          ? tinymce.get("teylerDescription1").getContent()
          : "",
        description2: tinymce.get("teylerDescription2")
          ? tinymce.get("teylerDescription2").getContent()
          : "",
        faq: [
          {
            question: tinymce.get("teylerFAQQuestion1")
              ? tinymce.get("teylerFAQQuestion1").getContent()
              : "",
            answer: tinymce.get("teylerFAQAnswer1")
              ? tinymce.get("teylerFAQAnswer1").getContent()
              : "",
          },
          {
            question: tinymce.get("teylerFAQQuestion2")
              ? tinymce.get("teylerFAQQuestion2").getContent()
              : "",
            answer: tinymce.get("teylerFAQAnswer2")
              ? tinymce.get("teylerFAQAnswer2").getContent()
              : "",
          },
          {
            question: tinymce.get("teylerFAQQuestion3")
              ? tinymce.get("teylerFAQQuestion3").getContent()
              : "",
            answer: tinymce.get("teylerFAQAnswer3")
              ? tinymce.get("teylerFAQAnswer3").getContent()
              : "",
          },
          {
            question: tinymce.get("teylerFAQQuestion4")
              ? tinymce.get("teylerFAQQuestion4").getContent()
              : "",
            answer: tinymce.get("teylerFAQAnswer4")
              ? tinymce.get("teylerFAQAnswer4").getContent()
              : "",
          },
          {
            question: tinymce.get("teylerFAQQuestion5")
              ? tinymce.get("teylerFAQQuestion5").getContent()
              : "",
            answer: tinymce.get("teylerFAQAnswer5")
              ? tinymce.get("teylerFAQAnswer5").getContent()
              : "",
          },
        ],
      },
      lorentzSection: {
        title: tinymce.get("lorentzTitle")
          ? tinymce.get("lorentzTitle").getContent()
          : "",
        description1: tinymce.get("lorentzDescription1")
          ? tinymce.get("lorentzDescription1").getContent()
          : "",
        description2: tinymce.get("lorentzDescription2")
          ? tinymce.get("lorentzDescription2").getContent()
          : "",
        faq: [
          {
            question: tinymce.get("lorentzFAQQuestion1")
              ? tinymce.get("lorentzFAQQuestion1").getContent()
              : "",
            answer: tinymce.get("lorentzFAQAnswer1")
              ? tinymce.get("lorentzFAQAnswer1").getContent()
              : "",
          },
          {
            question: tinymce.get("lorentzFAQQuestion2")
              ? tinymce.get("lorentzFAQQuestion2").getContent()
              : "",
            answer: tinymce.get("lorentzFAQAnswer2")
              ? tinymce.get("lorentzFAQAnswer2").getContent()
              : "",
          },
          {
            question: tinymce.get("lorentzFAQQuestion3")
              ? tinymce.get("lorentzFAQQuestion3").getContent()
              : "",
            answer: tinymce.get("lorentzFAQAnswer3")
              ? tinymce.get("lorentzFAQAnswer3").getContent()
              : "",
          },
          {
            question: tinymce.get("lorentzFAQQuestion4")
              ? tinymce.get("lorentzFAQQuestion4").getContent()
              : "",
            answer: tinymce.get("lorentzFAQAnswer4")
              ? tinymce.get("lorentzFAQAnswer4").getContent()
              : "",
          },
          {
            question: tinymce.get("lorentzFAQQuestion5")
              ? tinymce.get("lorentzFAQQuestion5").getContent()
              : "",
            answer: tinymce.get("lorentzFAQAnswer5")
              ? tinymce.get("lorentzFAQAnswer5").getContent()
              : "",
          },
        ],
      },
